...
This project was solely made by the intent to learn, understand and strengthen React Context API fundamentals. Thanks to insanely helpful, amazing and commendable my teacher [Sir. Hitesh's Chai-aur-React Series](https://github.com/hiteshchoudhary/chai-aur-react?tab=readme-ov-file)
